...
Run: 2026-07-25T16:00:00Z · Window: last 7 days

6 signal(s) active in this window, across 6 total signal(s) in the registry.

## Top Research Opportunity this window (for Headquarters to surface, if it chooses)

RES-0006 — How AI Agents are transforming scientific discovery (Conjecture Machines: AI agents and the new validation bottleneck in science) (confidence MEDIUM, 1 possible experiment(s)). Not an automatic prioritization - one candidate among the signals below, shown for visibility only.
