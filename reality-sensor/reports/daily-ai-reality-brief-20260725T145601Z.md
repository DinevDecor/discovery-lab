...
Run: 2026-07-25T14:56:01Z

8 new signal(s), 0 updated signal(s) this run.

This tool is a sensor, not a decision-maker. Every recommended action below is advisory only - see reality-sensor/CONTRACT.md.
